...
class ProjectController extends Controller
{
    ...
    public function addProject(Request $request)
    {
        ...
        $email_author = $request->input('email_author');
        $email_co_author = $request->input('email_co_author');
        $tel_author = $request->input('tel_author');
        $tel_co_author =  $request->input('tel_co_author');
        ...
        $project->email_author = $email_author;
        $project->email_co_author = $email_co_author;
        $project->tel_author = $tel_author;
        $project->tel_co_author = $tel_co_author;
    ...
    public function updateproject(Request $request)
    {
        ...
        $abtract = $request->input('abtract');
        $adviser = $request->input('adviser');
        $co_adviser = $request->input('adviser2');
        $branch = $request->input('branch');
        $cate_id  = $request->input('edt_cate_id');
        $gen = $request->input('gen');
        $project = Projects::find($project_id);
