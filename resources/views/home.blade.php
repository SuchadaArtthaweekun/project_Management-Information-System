        ...
        <div class="bannertop">
            <div class="row titlebanner">
                <div class="col action">
                    <div class="actiontxt">
                        <h3>สาขาวิชาเทคโนโลยีสารสนเทศ มหาวิทยาลัยราชภัฏบุรีรัมย์</h3>
                        <h5>
            ...
            <div class="showbook">
                ...
                <div class="bookcontent">
                    <div class="row bookthumnail">
                        @foreach ($book as $books)
                            <div class="col-3 bkall">
                                <a href="Document/{{ $books->project_id }}">
                                    <div class="bkcnt">
                                        <div class="bk title">
                                            {{ $books->title_th }}
                                        </div>
                                        <div class="bk author">
                                            ผู้จัดทำ : {{ $books->author }} {{ $books->co_author }}
                                        </div>
                                        <div class="bk endtitle">
                                            หมวดหมู่ : {{ $books->catename }}
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            <div class="row book">
                @foreach ($book as $books)
                    <div class="col book">
                        <a href="">
                            <div class="book">
                                <div class="imgbook"><img src="{{ asset('/img/book/LOGO-bru.png') }}"></div>
                                <div class="titlebook">
                                    {{ $books->title_th }}
                                    <br>
                                    {{ $books->title_en }}
                                ...
                                <div class="endtitlebook">
                                    <p>โครงงานนักศึกษานี้เป็นส่วนหนึ่งของการศึกษาตามหลักสูตร</p>
                                    <p>วิทยศาสตร์บัณฑิต</p>
                                    <p>สาขาวิชาเทคโนโลยีสารสนเทศ</p>
                                    <p>คณะวิทยาศาสตร์ มหาวิทยาลัยราชภัฏบุรีรัมย์</p>
                                    <p>ปีการศึกษา {{ $books->edition }}</p>
                                </div>
                            </div>
                        </a>
                    </div>
