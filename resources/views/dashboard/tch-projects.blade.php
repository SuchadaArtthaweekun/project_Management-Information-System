                ...
                <tbody>
                    @foreach ($projects as $pro)
                        <tr>
                            <th>
                            <td>
                                <strong> รหัสโครงงาน :</strong> {{ $pro->project_id }} <strong> ผู้จัดทำ :</strong>
                                {{ $pro->author }} {{ $pro->co_author }} <br>
                                <strong>ชื่อโครงงาน :</strong> {{ $pro->title_th }} <br>
                                {{ $pro->title_en }}
                                <br>
                                <strong>หมวดหมู่โครงงาน : </strong> {{ $pro->catename }} <br>
                                <strong>ปีที่พิมพ์ :</strong> {{ $pro->edition }} <strong>เผยแพร่ :</strong> {{ $pro->published }}
                                <strong>รุ่น: </strong>{{ $pro->gen }}
                                <div>
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#modal_{{ $pro->project_id }}">
                                                ...
                                                <form method="POST" action="{{ route('stdUpdateproject') }}">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" value="{{ $pro->project_id }}"
                                                                    name="project_id">
                                                                <input type="text"
                                                                    value="{{ $pro->author }}"class="form-control"
                                                                    name="author">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="co_author">ชื่อผู้ทำคนที่ 2</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="cate_id">หมวดหมู่โครงงาน : {{ $pro->cate_id }}
                                                                </label>
                                                                <select class="form-control" id="exampleFormControlSelect1"
                                                                    name="edt_cate_id" id="etd_cate_id"
                                                                    placeholder="หมวดหมู่โครงงาน">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" onclick="conf()"
                                                            href="{{ route('stddashboard') }}">บันทึก</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
